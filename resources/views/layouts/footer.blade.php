        ...
        <div class="main-footer widgets-dark typo-light">
            ...
            <div class="row">
              <div class="col-xs-12 col-sm-6 col-md-3">
                <div class="widget subscribe no-box">
                  <h5 class="widget-title">
                    Feedback Form
                       <h5><span>Name</span> <input type="text" class="form-control" ></h5>
                       <h5><span>Email</span> <input type="text" class="form-control"></h5>
                       <h5><span>Description</span> <br><textarea  row="10" style="font-size:1rem;" class="form-control" ></textarea></h5>
                  ...
                  <ul class="thumbnail-widget">
                    <li>
                      <div class="thumb-content">
                        <a href="https://github.com/kyr1234">Yug Khokhar</a>
                      </div>
                    </li>
                    <li>
                      <div class="thumb-content">
                        <a href="https://github.com/vaibhav-believer">Vaibhav Chauhan</a>
                      </div>
                    </li>
                    <li>
                      <div class="thumb-content">
                        <a href="https://github.com/JAIMIN-CHOKHAWALA">Jaimin Chokhawala</a>
                      </div>
                    </li>
                    <li>
                      <div class="thumb-content">
                        <a href="https://github.com/heet2312">Heet Senghani</a>
                      </div>
                    </li>
                  </ul>
                </div>
              ...
              <div class="col-xs-12 col-sm-6 col-md-3">
                <div class="widget no-box">
                  ...
                  <p>We want to provide the platform where every club of college can interact with students properly and can easily provide important event details. </p>
                  <a
                    class="btn"
                ...
                <div class="widget no-box">
                  ...
                  <p>
                    <a href="mailto:info@domain.com" title="glorythemes">
                     clubsabha@gmail.com<br>
                     Contact No: +919998392865
                    </a>
                  </p>
          ...
          <div class="footer-copyright" style = "">
            <div class="col-md-12 text-center">
              <p>Copyright ClubSabha © 2021. All rights reserved.</p>
            </div>
          </div>
        </div>
